...
@Schema(description = "Payload for registering a new set of scoring weight configuration parameters")
public record WeightConfigurationRequest(
        ...
        @Schema(description = "Identifier of the administrator user creating this configuration", example = "1")
